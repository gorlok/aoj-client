...
On Error Resume Next
    ...
    Debug.Print "HANDLE:" & incomingData.PeekByte()
...
Private Sub HandleUserCharIndexInServer()
    Debug.Print "HandleUserCharIndexInServer"
'***************************************************
'Author: Juan Martín Sotuyo Dodero (Maraxus)
'Last Modification: 05/17/06
'
...
Private Sub HandleCharacterCreate()
    Debug.Print "HandleCharacterCreate"
'***************************************************
'Author: Juan Martín Sotuyo Dodero (Maraxus)
'Last Modification: 05/17/06
'
...
Private Sub HandleObjectCreate()
    Debug.Print "HandleObjectCreate"
'***************************************************
'Author: Juan Martín Sotuyo Dodero (Maraxus)
'Last Modification: 05/17/06
'
...
Private Sub HandleBlockPosition()
    Debug.Print "HandleBlockPosition"
'***************************************************
'Author: Juan Martín Sotuyo Dodero (Maraxus)
'Last Modification: 05/17/06
'
...
Private Sub HandleUpdateUserStats()
    Debug.Print "HandleUpdateUserStats"
...
Private Sub HandleChangeInventorySlot()
    Debug.Print "HandleChangeInventorySlot"
'***************************************************
'Author: Juan Martín Sotuyo Dodero (Maraxus)
'Last Modification: 05/17/06
'
...
Private Sub HandleChangeSpellSlot()
    Debug.Print "HandleChangeSpellSlot"
